 ...
 * Forked from https://github.com/apache/couchdb-nano/blob/0951133d9c1bace58ca4cd100eb062ea06ddfc99/lib/nano.d.ts
 */
...
export interface ChangesReaderScope {
 ...
 * @see Docs: {@link http://docs.couchdb.org/en/latest/api/server/common.html#post--_replicate} */
export interface DatabaseReplicationHistoryItem {
 ...
 * @see Docs: {@link http://docs.couchdb.org/en/latest/api/server/common.html#post--_replicate} */
export interface DatabaseReplicateResponse {
  /** Replication history */
 ...
 * @see Docs: {@link http://docs.couchdb.org/en/latest/api/server/common.html#get--_db_updates} */
export interface DatabaseUpdatesResultItem {
  /** Database name. */
  db_name: string
 ...
 * @see Docs: {@link http://docs.couchdb.org/en/latest/api/server/common.html#get--_db_updates} */
export interface DatabaseUpdatesResponse {
...
export interface DocumentHeadResponseHeaders {
