    ...
    buildQueryString: (query = {}) => {
      ...
      for (const key of Object.keys(query)) {
        if (Object.prototype.hasOwnProperty.call(query, key)) {
          validateQueryKey(key, query)
          if (viewQueryKeys[key] === 'json') {
...
const validateQueryKey = (key, query) => {
  if (viewQueryKeys[key] == null) {
    throw errors_.new('invalid query key', 400, { key, query, validKeys: Object.keys(viewQueryKeys) })
  }
}
