    ...
    revertLastChange: function (docId) {
      ...
      .then(function (revsInfo) {
        ...
        if (previousRevInfo == null) {
          throw errors_.new('no previous version could be found', 400, { doc: docId })
        }
        if (previousRevInfo.status !== 'available') {
          throw errors_.new('previous version isnt available', 400, {
            doc: docId, rev_info: previousRevInfo
          })
        }
